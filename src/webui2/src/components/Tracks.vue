  ...
  <ul class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 mb-36 sm:mb-24">
    ...
    >
      <button
        ...
        class="inline-flex items-center rounded-lg px-20 py-12 text-sl-disabled font-bold text-2xl leading-none uppercase tracking-wide focus:outline-none"
      >
        <svg
          aria-hidden="true"
          focusable="false"
        ...
        >
          <path
            :class="{'sm:invisible': !newTrackVisible}"
            fill="currentColor"
